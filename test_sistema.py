...
class TestSistemaPonto:
    def __init__(self):
        ...
        try:
            ...
            self.automacao_teste = AutomacaoPonto(
    ...
    def testar_navegacao_sem_registro(self):
        """Abre o navegador e navega até a tela de ponto sem registrar"""
        try:
            self.logger.info("[TESTE] Abrindo navegador para navegação sem registro")
            self.automacao_teste.abrir_e_navegar_sem_registro(espera_segundos=10)
        except Exception as e:
            self.logger.error(f"[TESTE] Erro na navegação sem registro: {e}")
    ...
    def executar_testes(self):
        try:
            ...
            self.testar_navegacao_sem_registro()
